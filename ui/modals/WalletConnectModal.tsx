...
const WalletConnectModal = forwardRef<HTMLInputElement, ModalProps>(
  ({ close }, ref) => {
          ...
          <div className='bg-[#111] rounded-[8.61px] modal-box p-3 flex flex-col justify-start items-center gap-7 z-20 overflow-visible'>
            ...
            <div className='flex flex-col px-2 md:px-6 gap-4 w-full max-md:pl-5 max-md:max-w-full'>
              <div className='flex flex-col justify-start items-start gap-4'>
                <h1 className='text-xl md:text-3xl text-white  font-medium max-md:max-w-full'>
                  Welcome to Moniswap
                </h1>
                <p className='text-base  text-stone-300 max-md:max-w-full'>
                  ...
                  .map((connector, index) => (
                    ...
                    >
                      ...
                      <Image
                        src={
                          __PROVIDERS__[
                            connector.id as keyof typeof __PROVIDERS__
                          ]?.image
                        }
                        alt={
                          __PROVIDERS__[
