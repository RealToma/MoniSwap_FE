...
export const Vote = () => {
  ...
  return (
    <div className='container pt-[89px] pb-4 px-5 lg:px-8 xl:px-0'>
      <h1 className='text-[25px]  text-white font-medium leading-[30.26px]'>
      ...
      <div className='bg-[#1E1E1E] rounded-xl mt-[13px] grid grid-cols-5 py-[15px] pl-[32px] pr-[25px]'>
        <div>
      ...
      <div className='mt-[13px] bg-[#1E1E1E] rounded-xl'>
